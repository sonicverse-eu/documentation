...
function LoadingIndicator() {
  return (
    <div className="flex gap-0.5 items-end h-3 py-2 mb-4">
      <span className="size-1 bg-(--primary) rounded-full animate-dot-bounce" />
      <span className="size-1 bg-(--primary) rounded-full animate-dot-bounce [animation-delay:0.2s]" />
      <span className="size-1 bg-(--primary) rounded-full animate-dot-bounce [animation-delay:0.4s]" />
    </div>
  );
}
