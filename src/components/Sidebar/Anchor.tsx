  ...
  return (
    <a
      ...
      className={cn(
        ...
        'text-[rgba(16,18,20,0.62)] hover:text-[#101214]',
      )}
    >
      {icon && (
        <span
          className={cn(
            ...
            'group-hover:[background:var(--anchor-color)] ring-1 ring-[rgba(16,18,20,0.08)]',
          )}
        >
          <Icon
            icon={icon}
            iconLibrary="lucide"
            className="bg-[rgba(16,18,20,0.62)] group-hover:bg-white"
            overrideColor
            size={16}
          />
        </span>
