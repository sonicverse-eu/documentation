---
title: "Quickstart"
description: "Set up the Sonicverse docs locally and build for deployment"
---
...
<Steps>
  ...
  <Step title="Start the dev server">
    ...
    Open the URL shown in your terminal (usually `http://localhost:4321`) to see the docs.
  </Step>
...
Push your changes to GitHub. Vercel can build this Astro site from the included `vercel.json` configuration.
