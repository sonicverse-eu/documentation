---
title: "Components"
description: "Available MDX components for building Sonicverse documentation pages"
---

MDX components work directly in Sonicverse docs pages without imports. This page shows each component rendered so authors can see what is available. For all available components, see the [Mintlify documentation](https://mintlify.com/docs/components).
...
<AccordionGroup>
  ...
  <Accordion title="Do I need to import components?">
    No. The configured MDX components are available globally in all docs files.
  </Accordion>
</AccordionGroup>
